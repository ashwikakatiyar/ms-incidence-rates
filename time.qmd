...
# graph. Opted not to add subtitle since key takeaways were listed in paragraph
# below. Used minimal theme for clean look.

ms_line <-
  ms_data_clean_time |>
  ggplot(aes(x = Year, y = `Incidence Rate`, color = Sex)) +
  geom_line(linewidth = 0.5) +
  scale_color_manual(values = wes_palette("FantasticFox1")[3:5]) +
