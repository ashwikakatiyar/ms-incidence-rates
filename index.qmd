...
interactive_bar <- 
  ggplotly(ms_bar, tooltip = c("Age", "Incidence Rate")) |>
    layout( annotations = list(
      ...
      x = 1, y = -0.25,  # Adjust these values to position the caption
